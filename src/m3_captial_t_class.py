...
class CapitalT(object):
    ...
    def __init__(self, intersection_center, width, height, letter_thickness):
        ...
        h_rect_top_left = rg.Point(intersection_center.x-width/2, intersection_center.y-letter_thickness/2)
        h_rect_bottom_right = rg.Point(intersection_center.x+width/2, intersection_center.y+letter_thickness/2)

        v_rect_top_left = rg.Point(intersection_center.x-letter_thickness/2, intersection_center.y-letter_thickness/2)
        v_rect_bottom_right = rg.Point(intersection_center.x+letter_thickness/2, intersection_center.y+height-letter_thickness/2)

        self.v_rect = rg.Rectangle(v_rect_bottom_right, v_rect_top_left)
        self.h_rect = rg.Rectangle(h_rect_bottom_right, h_rect_top_left)
    ...
    def clone(self):
        ...
        cloned_t = CapitalT(self.intersection_center, self.width, self.height, self.letter_thickness)
